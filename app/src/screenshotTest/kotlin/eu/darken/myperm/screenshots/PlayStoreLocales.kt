 ...
 */
@Preview(locale = "af-rZA", name = "af", device = DS)
...
@Preview(locale = "bn-rBD", name = "bn-BD", device = DS)
...
@Preview(locale = "hi-rIN", name = "hi-IN", device = DS)
...
@Preview(locale = "zh-rTW", name = "zh-TW", device = DS)
