...
private val UPGRADE_BENEFITS = listOf(
    ...
    R.string.upgrade_benefit_filtering,
    R.string.upgrade_benefit_export,
    R.string.upgrade_benefit_monitoring,
    R.string.upgrade_benefit_manifest_viewer,
...
internal fun UpgradeMascot(
    ...
    Image(
        // PP ships a single mascot asset. The happy/grumpy split stays in the tags so the mood is
        // still expressed to tests and future artwork.
...
private const val PREVIEW_PREAMBLE =
    "Permission Pilot is developed by a single person. Upgrading unlocks extra features and helps " +
        "keep the app alive."
